...
import { RoutePlanner, locations } from '../components/RoutePlanner';
    ...
    return (
        <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
                ...
                <div>
                    {/* Weather Card */}
                    <div className="card" style={{ background: 'linear-gradient(to bottom right, #3b82f6, #1e40af)', color: 'white' }}>
